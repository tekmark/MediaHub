 ...
 * {@link PlaylistMgmtFragment.OnInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PlaylistMgmtFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PlaylistMgmtFragment extends Fragment {

    final static private String TAG = "PlaylistsMgmtFrag";
     ...
     * @return A new instance of fragment PlaylistMgmtFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PlaylistMgmtFragment newInstance(String param1, String param2) {
        PlaylistMgmtFragment fragment = new PlaylistMgmtFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            Log.d(TAG, "Param1 : " + mParam1 + ", Param2 : " + mParam2);
            playlist_id = Integer.parseInt(mParam1);
        }
    }
...
//            mListener.onFragmentInteraction(uri);
    ...
    private void setListeners() {
        ...
        mBtnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "Delete Button onClick(), playlist_id : " + playlist_id);
                mListener.onDeleteDialog();
//                MediaManager.deletePlaylist(getContext(), playlist_id);
            }
        });
    }
